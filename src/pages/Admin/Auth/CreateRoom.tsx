...
//   //  })
//   // });
//   const onHandleSubmit = handleSubmit( (data: any,e:any) => {
//     const { roomSize, bedSize, Guest,roomType,description,amount } = data
// e.preventDefault()
// console.log("dummy2",data)
...
// const [four,setFour] = useState<any>(0)
// const [five,setFive] = useState("")
// const [six,setSix] = useState("")
 

// formData.append("roomSize", one)
// formData.append("bedSize", two)
// formData.append("Guest", six)
// formData.append("roomType", three)
// formData.append("description", five)
// formData.append("amount", four)
// formData.append("image", image)
// //
...
//             <div>Room Type: </div>
//             <div className="my-2 w-[300px] mx-2 border-[1px] border-[#024637] rounded-[5px] bg-purple-700 h-[30px] ">
//               <input
...
//               />
//             </div>
//           {errors?.Guest?.message &&   <div className="text-[10px] text-[#024637]  absolute top-12 right-7 mb-1">
//           Guest Error
//             </div>}
//           </div>
//           {/* BED SIZE */}
