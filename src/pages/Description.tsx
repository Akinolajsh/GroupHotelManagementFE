...
const Description = () => {
  return (
    <div className=" flex justify-center flex-col items-center bg-[#FFFFFF] w-[100%]">
        ...
        {/* card big one */}
        <div className="w-[100%]  mt-10 flex justify-center bg-[silver]">
        <div className="w-[780px] flex flex-col  bg-[white] rounded mt-7 hover:cursor-pointer   ">
            {/* inputs */}
            <div className="ml-[20px] mt-[10px] p-2 flex items-center gap-2 ">
                <input className="flex justify-center items-center outline-none border w-[350px] h-[40px] rounded font-semibold text-[#024637]"
